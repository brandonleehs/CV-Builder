...
export default function Profile() {
  ...
  const inputStyle =
    "placeholder:font-gray-600 rounded-md border-0 bg-gray-100 px-3 py-2 focus:outline-2 focus:outline-gray-400";
  return (
    <section className="[&_label]:font-gray-900 grid gap-2 p-4 text-[0.875rem] [&_label]:text-sm">
      <Photo />
